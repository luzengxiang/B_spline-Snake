...
image_size = (150,150)
GVF_generator_1 = GVF.GVF_generator(gaussian_size=5,edge_threshold=0.50,gradient_smooth=None,mu=0.5)
...
B_Spline_1 = Contour_extractor_1.fit_B_spline(image_GVF,image=gray_image,second_loop_break_inspect_time= 60)
